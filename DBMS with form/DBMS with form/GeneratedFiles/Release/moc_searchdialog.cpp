...
QT_MOC_LITERAL(7, 84, 16)
    ...
    "SearchDialog\0finded\0\0QAbstractTableModel*\0"
    "on_pButton_find_clicked\0changedClass\0"
    "indx\0changedCodeGroup\0"
};
...
void SearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->finded((*reinterpret_cast< QAbstractTableModel*(*)>(_a[1]))); break;
        case 1: _t->on_pButton_find_clicked(); break;
        case 2: _t->changedClass((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->changedCodeGroup((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (SearchDialog::*_t)(QAbstractTableModel * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchDialog::finded)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SearchDialog::finded(QAbstractTableModel * _t1)
{
